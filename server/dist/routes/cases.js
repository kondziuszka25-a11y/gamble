...
exports.CASES_CATALOGUE = void 0;
const express_1 = require("express");
const zod_1 = require("zod");
const prisma_1 = require("../lib/prisma");
const auth_1 = require("../middleware/auth");
const router = (0, express_1.Router)();
exports.CASES_CATALOGUE = [
    {
        id: 'starter_crate',
...
router.get('/', (_req, res) => {
    res.json(exports.CASES_CATALOGUE);
});
// POST /api/cases/open — open a case
router.post('/open', auth_1.requireAuth, async (req, res) => {
    const schema = zod_1.z.object({ caseId: zod_1.z.string() });
    ...
    const caseDef = exports.CASES_CATALOGUE.find((c) => c.id === caseId);
    if (!caseDef) {
    ...
    const [createdItem, updatedUser] = await prisma_1.prisma.$transaction([
        prisma_1.prisma.collectibleItem.create({
            data: {
                userId: user.id,
                name: wonDrop.name,
